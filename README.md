Used React, Javascript, Redux and Material UI to create a recipe search website with a built in Calorie Calculator that automatically gives users recipes needed to lose weight.
